...
type ClientCategoryViewScreenRouteProp = RouteProp<{ ClientCategoryDetails: { clientCategory : ClientCategoryDto } }, 'ClientCategoryDetails'>;

type Props = { route: ClientCategoryViewScreenRouteProp; };

const ClientCategoryAdminView: React.FC<Props> = ({ route }) => {
