...
type ProductViewScreenRouteProp = RouteProp<{ ProductDetails: { product : ProductDto } }, 'ProductDetails'>;

type Props = { route: ProductViewScreenRouteProp; };

const ProductAdminView: React.FC<Props> = ({ route }) => {
