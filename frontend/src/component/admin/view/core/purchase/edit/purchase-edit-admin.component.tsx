...
return(
    <SafeAreaView style={{ flex: 1, backgroundColor: '#e6e8fa' }}>
        ...
        <ScrollView style={{ margin: 20 }} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
            ...
            <Text style={{ fontSize: 30, fontWeight: 'bold', alignSelf: 'center', marginBottom: 10 }} >Update Purchase</Text>
            ...
            <CustomButton onPress={handleSubmit(handleUpdate)} text={"Update Purchase"} bgColor={'#ffa500'} fgColor={'white'} />
        ...
        item.client = selectedClient;
        <FilterModal visibility={clientModalVisible} placeholder={"Select a Client"} onItemSelect={onClientSelect} items={clients} onClose={handleCloseClientModal} variable={'fullName'} />
